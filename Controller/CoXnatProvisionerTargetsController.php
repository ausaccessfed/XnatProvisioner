<?php
/**
 * COmanage Registry CO Dataverse Provisioner Targets Controller
 *
...
class CoXnatProvisionerTargetsController extends SPTController {
  // Class name, used by Cake
  public $name = "CoXnatProvisionerTargets";
