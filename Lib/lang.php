...
$cm_xnat_provisioner_texts['en_US'] = array(
  ...
  'pl.xnatprovisioner.name_type'                   => 'Name Type for XNAT',
  'pl.xnatprovisioner.name_type.desc'              => 'Name type used as the XNAT name. <br><b>Official</b> is recommended if invitation enrollment flows are configured to use <b>Alternate</b> Names',
  ...
  'pl.xnatprovisioner.usage'                       => 'XNAT Provisioner Plugin version: v0.3.9 <br>COmanage: v4.3.x <br>  XNAT: v1.8.10.1, build: 52',
